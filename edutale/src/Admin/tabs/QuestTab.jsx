        ...
        <div className="quest-tab">
          ...
          <div className="quest-forms">
            ...
            <QuestForm type="update" quests={quests} onQuestChange={handleQuestChange}
                       onSubmit={(e) => handleSubmit(e, (data) => questService.updateQuest(data.questId, {questName: data.questName, questDescription: data.questDescription}), "Quest Updated Successfully")}/>
