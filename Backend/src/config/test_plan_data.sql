...
('TESTQUE38', 'Swap Elements', 'Create a webpage that swaps two HTML elements at the puch of a button!', 2, true),
...
('RES000165', 'Mozilla JS DOM', 'https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Introduction', 'The Mozilla page for the JavaScript DOM.'),
('RES000167', 'Mozilla - Script Tag', 'https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script', 'The Mozilla webpage that talks about script tags.');
